            ...
            <div className="col-lg">
              <div className="trending__product">
                ...
                <div class="row">
                    ...
                    <div class="btn__all">
                      <a class="primary-btn">
                       <Link to='/Upcoming'>View All <span class="arrow_right"></span></Link> 
                      </a>
                    </div>
                  </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="btn__all">
                      <a class="primary-btn">
                       <Link to='/Top'>View All <span class="arrow_right"></span></Link> 
                      </a>
                    </div>
                  </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="btn__all">
                      <a class="primary-btn">
                       <Link to='/Season'>View All <span class="arrow_right"></span></Link> 
                      </a>
                    </div>
                  </div>
                  </div>
